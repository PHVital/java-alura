...
public class EmailService {
    ...
    public void enviarEmailConfirmacao(Usuario usuario) {
        ...
        String assunto = "Confirme seu cadastro - Clínica Voll Med";

        String link = URL_SITE + "/confirmar-conta?token=" + usuario.getToken();

        String conteudo = gerarConteudoEmail(
                "Olá [[name]],<br><br>"
                        + "Clique no link abaixo para ativar sua conta:<br>"
                        + "<h3><a href=\"[[URL]]\">ATIVAR CONTA</a></h3><br>"
                        + "Se você não solicitou este cadastro, ignore este e-mail.<br><br>"
                        + "Clínica Voll Med.",
                usuario.getNome(),
                link
        );
